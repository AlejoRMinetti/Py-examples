...
@click.group() # Agrupa una serie de comandos: pv clients command
def clients():
...
#  ctx es el contexto creado como diccionario vacio en def cli(ctx):
@clients.command()
@click.pass_context
def list(ctx):
    """List all clients"""
...
all = clients
""" Para poder incoroporar todos con un unico add_command en pv.py:
